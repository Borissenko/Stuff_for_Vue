<template>
<!--  Два столбика, каждый из которых содержит несколько элементов.-->
<!--  Необходимо выбрать элементу из левого столбика "А" соответствующий элемент из правого столбика "В".-->
<!--  Соответствие нагдлялно демонстрируется сходным цветом а выбранной пары элементов. -->
